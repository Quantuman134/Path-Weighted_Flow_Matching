#!/bin/bash
# Validation sweep: SiT-B/2, vanilla_weighting_v lam=0.5, 50k ImageNet subset with latent sigma 2.0
...
CONFIG="configs/exp_model_validation_config_B_vanilla_05_imagenet50k_std20.yaml"
