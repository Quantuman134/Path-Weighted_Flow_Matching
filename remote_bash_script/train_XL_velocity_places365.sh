...
# SiT Training Script -- SiT-XL/2, unweighted velocity MSE (vanilla flow matching), Places365-Standard
config_file="./configs/sit_config_XL_velocity_places365.yaml"
