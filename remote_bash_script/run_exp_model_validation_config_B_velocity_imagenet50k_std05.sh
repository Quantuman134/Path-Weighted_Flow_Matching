#!/bin/bash
# Validation sweep: SiT-B/2, baseline (unweighted velocity MSE), 50k ImageNet subset with latent sigma 0.5
...
CONFIG="configs/exp_model_validation_config_B_velocity_imagenet50k_std05.yaml"
