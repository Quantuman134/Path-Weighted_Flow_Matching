#!/bin/bash
# Baseline: unweighted velocity MSE (plain flow matching)
# Dataset: imagenet50k-std0.5 (latent sigma 0.5, scale 0.6097561)
...
config_file="./configs/sit_config_B_velocity_imagenet50k_std05.yaml"
