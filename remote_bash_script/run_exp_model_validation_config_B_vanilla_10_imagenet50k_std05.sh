#!/bin/bash
# Validation sweep: SiT-B/2, vanilla_weighting_v lam=1.0, 50k ImageNet subset with latent sigma 0.5
...
CONFIG="configs/exp_model_validation_config_B_vanilla_10_imagenet50k_std05.yaml"
